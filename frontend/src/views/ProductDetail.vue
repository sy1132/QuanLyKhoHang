  ...
  <div class="add-product-modal" v-if="product">
    <form class="add-product-form" @submit.prevent="editMode ? updateProduct() : null">
      <div class="form-grid">
        ...
        <div class="form-group image-upload-group" style="align-items:flex-start;">
          <div class="product-detail-image-block">
            <img :src="product.image || defaultImg" alt="Ảnh sản phẩm" class="product-detail-image" />
          </div>
        </div>
      ...
      <div class="form-actions">
        <button v-if="!editMode" type="button" class="btn green" @click="editMode = true"><i class="icon-save"></i> Cập
          nhật</button>
        ...
        <form class="add-product-form" @submit.prevent="updateProduct">
          <div class="form-grid-2col">
            ...
            <div>
              ...
              <div class="form-group full-width">
                <label>Mô tả</label>
                <textarea v-model="editProduct.description" placeholder="Nhập mô tả sản phẩm..."></textarea>
              </div>
            </div>
            <!-- Cột phải -->
            <div>
              ...
              <div class="form-group">
                ...
                <div class="image-preview-list">
                  ...
                  <img v-else-if="editProduct.image && typeof editProduct.image === 'string'" :src="editProduct.image"
                    class="image-preview" />
                </div>
              </div>
